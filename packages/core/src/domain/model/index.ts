...
/**
 * La ficha del arquetipo contada desde una perspectiva concreta.
 *
 * No cambia solo el nombre: la pregunta central, la sombra y los ejercicios se
 * dicen distinto segun quien mire. Por eso es una capa entera y no un campo.
 */
...
export interface Archetype {
  id: ArchetypeId;
  /** Nombre ya resuelto. Sin resolver, es el universal. */
  name: string;
